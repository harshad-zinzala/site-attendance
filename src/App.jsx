...
function App() {
  return (
    <div className="min-h-screen bg-slate-900 flex justify-center items-center p-0 md:p-4 font-sans select-none">
      ...
      */}
      <div className="w-full max-w-md h-screen md:h-[844px] bg-[#fbfbf9] md:rounded-[40px] md:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] md:border-[8px] md:border-slate-950 relative overflow-hidden flex flex-col">
