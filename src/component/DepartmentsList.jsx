...
export default function DepartmentsList({
  ...
  return (
    <>
      {/* 5. Notice Info Box */}
      <div className="p-4">
        <div className="bg-[#fff9f3] border border-[#fbe5cb]/60 rounded-3xl p-4.5 flex gap-3 text-slate-700 leading-relaxed shadow-sm">
          <AlertCircle className="text-[#e67e22] shrink-0 mt-0.5" size={20} />
          <p className="text-[12px] font-semibold text-slate-600">
            Each department head sets the worker count, then taps P / A / H / L to bulk-mark that count. Expand a department to mark attendance.
          </p>
        </div>
      </div>
