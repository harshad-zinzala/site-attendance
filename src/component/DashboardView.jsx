...
export default function DashboardView({ departments, stats, showToast }) {
  // Present percentage
    ...
    <div className="p-5 space-y-6 animate-fade-in bg-slate-50/30 min-h-full pb-[100px]">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-3">
            <h4 className="text-xl font-extrabold text-slate-800 leading-none">{stats.absent + stats.leave} <span className="text-xs text-slate-400 font-medium">workers</span></h4>
            <p className="text-[9px] text-slate-400 font-semibold mt-1">Absent or on leave</p>
          </div>
        </div>
      </div>
              ...
              <div key={dept.id} className="space-y-1">
                ...
                <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden flex">
                  ...
                  <div 
                    ...
                    style={{ width: `${(dept.absent / dept.totalWorkers) * 100}%` }}
