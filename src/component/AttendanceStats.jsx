...
export default function AttendanceStats({ stats }) {
  return (
    <div className="px-4 h-[75px] bg-white border-y border-slate-100 flex items-center gap-3 overflow-x-auto select-none no-scrollbar shrink-0">
      <div className="flex items-center gap-2 bg-[#ebeae4] px-[18px] py-[9px] rounded-full text-[13px] shrink-0 font-medium">
        <span className="w-2.5 h-2.5 rounded-full bg-slate-500 shrink-0"></span>
        <span className="font-extrabold text-slate-800 ml-0.5">{stats.total}</span>
        <span className="text-slate-500 ml-0.5 font-normal">Total</span>
      </div>
      ...
      <div className="flex items-center gap-2 bg-[#fdeeed] px-[18px] py-[9px] rounded-full text-[13px] shrink-0 font-medium">
        <span className="w-2.5 h-2.5 rounded-full bg-[#d32f2f] shrink-0"></span>
        <span className="font-extrabold text-[#b91c1c] ml-0.5">{stats.absent}</span>
        <span className="text-[#64748b] ml-0.5 font-normal">Absent</span>
      </div>
